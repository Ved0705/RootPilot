...
// V2: Hierarchical navigation organized by operational workflow
const nav = [
  // Primary entry: Command Center (Flagship)
  ['Command Center', '/', PsychologyIcon],
  ...
  // Root Cause Analysis
  ['Correlations', '/rca/correlations', HubIcon],
  ['Root Cause Analysis', '/rca/root-cause', PsychologyIcon],
  ['Predictive Analytics', '/rca/predictive', InsightsIcon],
  ...
  ['Dependencies', '/dependencies', HubIcon],
  
  // Automation & Insights
  ['Autonomous Actions', '/automation/actions', AutoFixHighIcon],
  ['Knowledge Graph', '/automation/knowledge-graph', AccountTreeIcon],
